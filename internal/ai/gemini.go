...
func (p *GeminiProvider) Generate(ctx context.Context, req *models.GenerationRequest) (*models.GenerationResponse, error) {
...
func (p *GeminiProvider) ValidateRequest(req *models.GenerationRequest) error {
	if req.Prompt == "" {
